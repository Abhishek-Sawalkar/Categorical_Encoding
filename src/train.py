...
if __name__ == "__main__":
    ...
    for c in train_df.columns:
        ...
        valid_df.loc[:, c] = lbl.transform(valid_df[c].tolist())
        df_test.loc[:, c] = lbl.transform(df_test[c].tolist())
    ...
    joblib.dump(label_encoders, f"Categorical_Encoding/models/{MODEL}_{FOLD}_label_encoder.pkl") 
    joblib.dump(clf, f"Categorical_Encoding/models/{MODEL}_{FOLD}.pkl")
